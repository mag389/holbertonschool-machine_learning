...
class Yolo():
    ...
    def load_images(folder_path):
        """ loads images from file
            ...
            Returns: tuple of (images, image_paths):
                images: listy of np.array images
    ...
    def preprocess_images(self, images):
        """ preprocess images
            images: list of np.array aimages
            resize intercubic
            rescale to pixels in [0, 1]
            return tuple of (pimages, image_shapes)
              pimages: np.array (ni, input_h, input_w, 3) processed pics
                ni: number of images
                input_h: input height of darknet model
                input_w: input width of darknet model
                3: color channels:
